  ...
  const additionalReadings = [
    {
      ...
      description: 'An accessible introduction to the five main approaches in machine learning and their philosophical foundations',
      type: 'Book',
      year: '2015',
    ...
    },
    {
      ...
      description: 'An economic framework for understanding AI as a tool that reduces the cost of prediction',
      type: 'Book',
      year: '2018',
    ...
    },
    {
      ...
      description: 'Explores how to align AI systems with human values, ethics, and intentions',
      type: 'Book',
      year: '2020',
    ...
    },
    {
      ...
      description: 'Foundational text on building analytics-driven organizations and competitive advantage through data',
      type: 'Book',
      year: '2007',
      publisher: 'Harvard Business Review Press',
    },
    {
      ...
      description: 'Critical examination of algorithmic bias, fairness, and the societal impacts of opaque ML systems',
      type: 'Book',
      year: '2016',
      publisher: 'Crown',
    },
