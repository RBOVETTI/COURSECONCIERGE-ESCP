        ...
        <div className="container-width">
          <div className="max-w-5xl mx-auto">
            <div className="card overflow-hidden">
              <iframe
                key={activeAssistant}
                src={assistants.find(a => a.key === activeAssistant)?.url}
                className="w-full border-0"
                style={{ height: '700px' }}
                title={assistants.find(a => a.key === activeAssistant)?.title}
                allow="clipboard-write"
              />
              <div className="p-4 bg-background-light border-t border-gray-200 text-center">
                <a
                  href={assistants.find(a => a.key === activeAssistant)?.url}
                  target="_blank"
